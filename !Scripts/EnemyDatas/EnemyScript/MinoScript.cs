...
public class MinoScript : MonoBehaviour
{
    ...
    private bool isAttack1Ready = true;
    ...
    private void Awake()
    {
        ...
        nextAttackTime1 = Time.time;
        nextAttackTime2 = Time.time;
    }
    ...
    private void AttackPlayer()
    {
        ...
        Debug.Log("bruh");
         ...
         if(isAttack2Ready && Time.time >= nextAttackTime2)
        {
            Debug.Log("attack2");
            isAttack2 = true;
            nextAttackTime2 = Time.time + 7.5f;
            isAttack1 = false; 
            isAttack2Ready = false;
        }
        else if (isAttack1Ready && Time.time >= nextAttackTime1)
        {
            Debug.Log("attack1");
            isAttack1 = true;
            nextAttackTime1 = Time.time + rhinoData.AttackCooldown;
            isAttack2 = false; 
        }
        else
        {
